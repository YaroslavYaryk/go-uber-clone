...
func (r *mongoRepository) SaveRideFare(ctx context.Context, fare *domain.RiderFareModel) error {
...
func (r *mongoRepository) GetRideFareByID(ctx context.Context, id string) (*domain.RiderFareModel, error) {
	_id, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return nil, err
	}
	...
	var fare domain.RiderFareModel
