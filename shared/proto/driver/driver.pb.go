...
const file_driver_proto_rawDesc = "" +
	...
	"\vpackageSlug\x18\x02 \x01(\tR\vpackageSlug\"D\n" +
	"\x16RegisterDriverResponse\x12*\n" +
	"\x06Driver\x18\x01 \x01(\v2\x12.trdriverip.DriverR\x06Driver\"\xde\x01\n" +
	"\x06Driver\x12\x0e\n" +
	...
	"\vpackageSlug\x18\x06 \x01(\tR\vpackageSlug\x120\n" +
	"\blocation\x18\a \x01(\v2\x14.trdriverip.LocationR\blocation\"D\n" +
	"\bLocation\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude2\xc3\x01\n" +
	"\rDriverService\x12W\n" +
	"\x0eRegisterDriver\x12!.trdriverip.RegisterDriverRequest\x1a\".trdriverip.RegisterDriverResponse\x12Y\n" +
	"\x10UnRegisterDriver\x12!.trdriverip.RegisterDriverRequest\x1a\".trdriverip.RegisterDriverResponseB\x1cZ\x1ashared/proto/driver;driverb\x06proto3"
...
var file_driver_proto_goTypes = []any{
	(*RegisterDriverRequest)(nil),  // 0: trdriverip.RegisterDriverRequest
	(*RegisterDriverResponse)(nil), // 1: trdriverip.RegisterDriverResponse
	(*Driver)(nil),                 // 2: trdriverip.Driver
	(*Location)(nil),               // 3: trdriverip.Location
}
var file_driver_proto_depIdxs = []int32{
	2, // 0: trdriverip.RegisterDriverResponse.Driver:type_name -> trdriverip.Driver
	3, // 1: trdriverip.Driver.location:type_name -> trdriverip.Location
	0, // 2: trdriverip.DriverService.RegisterDriver:input_type -> trdriverip.RegisterDriverRequest
	0, // 3: trdriverip.DriverService.UnRegisterDriver:input_type -> trdriverip.RegisterDriverRequest
	1, // 4: trdriverip.DriverService.RegisterDriver:output_type -> trdriverip.RegisterDriverResponse
	1, // 5: trdriverip.DriverService.UnRegisterDriver:output_type -> trdriverip.RegisterDriverResponse
